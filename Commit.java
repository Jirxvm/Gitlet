...
public class Commit implements Serializable {
    ...
    public Commit(String message, Commit parent) {
        _time = ZonedDateTime.now().format(FORMAT);
        _message = message;
    ...
    /** Returns this commit's time stamp. */
    ...
    public String getID() {
        ...
        return Utils.sha1(f.toString(), _parent, _message, _time);
    }
    ...
    public void updateTracking(Staging stg) {
